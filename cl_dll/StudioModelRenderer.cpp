...
void CStudioModelRenderer::Init( void )
{
	...
	m_pCvarFakeDrawEntities		= IEngineStudio.GetCvar( "r_fakedrawentities" );
...
{
	if( !m_pCvarFakeDrawEntities->value ) return 0;
	alight_t lighting;
	vec3_t dir;
...
void CStudioModelRenderer::StudioRenderFinal_Software( void )
{
	...
	else if (m_pCvarFakeDrawEntities->value == 3)
	{
	...
	if (m_pCvarFakeDrawEntities->value == 5)
	{
